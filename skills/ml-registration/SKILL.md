...
description: Guide AI and ML developers through closed-network ML Platform registration, including project scan, MLflow setup, job template review, readiness checks, package creation, and handoff.
---

# ML Platform Registration Skill

Use this skill when the user wants to register an AI/ML project to an internal ML Platform, create registration artifacts, prepare a Job Template, configure MLflow, or help a junior developer follow the registration flow without reading a long manual.
...
- Do not assume the internal ML Platform API schema unless it is provided.
